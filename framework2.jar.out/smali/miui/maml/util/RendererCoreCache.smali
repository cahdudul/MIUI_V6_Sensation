...
.method private get(Ljava/lang/Object;Landroid/content/Context;JLmiui/maml/ResourceLoader;Ljava/lang/String;Lmiui/maml/util/RendererCoreCache$OnCreateRootCallback;)Lmiui/maml/util/RendererCoreCache$RendererCoreInfo;
    ...
    .line 92
    .local v4, "root":Lmiui/maml/ScreenElementRoot;
    if-eqz p5, :cond_4

    .line 93
    new-instance v5, Lmiui/maml/ScreenElementRootFactory$Parameter;

    invoke-direct {v5, p2, p5}, Lmiui/maml/ScreenElementRootFactory$Parameter;-><init>(Landroid/content/Context;Lmiui/maml/ResourceLoader;)V

    invoke-virtual {v5, v0}, Lmiui/maml/ScreenElementRootFactory$Parameter;->setHandler(Landroid/os/Handler;)Lmiui/maml/ScreenElementRootFactory$Parameter;

    move-result-object v5

    invoke-static {v5}, Lmiui/maml/ScreenElementRootFactory;->create(Lmiui/maml/ScreenElementRootFactory$Parameter;)Lmiui/maml/ScreenElementRoot;
    ...
    .line 98
    invoke-interface {p7, v4}, Lmiui/maml/util/RendererCoreCache$OnCreateRootCallback;->onCreateRoot(Lmiui/maml/ScreenElementRoot;)V

    .line 100
    :cond_1
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lmiui/maml/ScreenElementRoot;->setDefaultFramerate(F)V
    ...
    invoke-virtual {v4}, Lmiui/maml/ScreenElementRoot;->load()Z
    ...
    .end local v1    # "r":Lmiui/maml/RendererCore;
    const/4 v5, 0x1

    invoke-static {v5}, Lmiui/maml/RenderThread;->globalThread(Z)Lmiui/maml/RenderThread;

    move-result-object v5

    invoke-direct {v1, v4, v5}, Lmiui/maml/RendererCore;-><init>(Lmiui/maml/ScreenElementRoot;Lmiui/maml/RenderThread;)V

    .line 107
    .restart local v1    # "r":Lmiui/maml/RendererCore;
    :cond_2
    ...
    iput-wide v5, v2, Lmiui/maml/util/RendererCoreCache$RendererCoreInfo;->accessTime:J
    ...
    .line 112
    new-instance v5, Lmiui/maml/util/RendererCoreCache$CheckCacheRunnable;

    invoke-direct {v5, p0, p1}, Lmiui/maml/util/RendererCoreCache$CheckCacheRunnable;-><init>(Lmiui/maml/util/RendererCoreCache;Ljava/lang/Object;)V

    iput-object v5, v2, Lmiui/maml/util/RendererCoreCache$RendererCoreInfo;->checkCache:Lmiui/maml/util/RendererCoreCache$CheckCacheRunnable;

    .line 114
    :cond_3
    iget-object v5, p0, Lmiui/maml/util/RendererCoreCache;->mCaches:Ljava/util/HashMap;
    ...
    invoke-direct {v5, p2, p6}, Lmiui/maml/ScreenElementRootFactory$Parameter;-><init>(Landroid/content/Context;Ljava/lang/String;)V
